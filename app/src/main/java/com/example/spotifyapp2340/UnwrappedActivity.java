...
import static com.example.spotifyapp2340.R.id.buttonPlay;
...
public class UnwrappedActivity extends AppCompatActivity {
    ...
    private Button buttonThisWeek, buttonLastSixMonths, buttonThisYear, tracksButtonThisWeek,tracksButtonLastSixMonths,
            tracksButtonThisYear, buttonPlay;
